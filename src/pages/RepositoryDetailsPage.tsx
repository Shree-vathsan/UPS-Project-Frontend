...
type LocationState = {
  ...
  fileTree?: FileNode[];
  codeSnippet?: string;
  activeTab?: "commits" | "pull-requests" | "files"; // ⭐ CHANGED
};
...
const RepositoryDetailsPage: React.FC = () => {
  ...
  // ⭐ CHANGED — Read active tab from navigation state
  // const initialTab =
  ...
  // const initialTab = location.state?.activeTab ?? 'commits';
      ...
      <main className="max-w-6xl mx-auto pt-8 px-6">
        ...
        <div className="min-h-[400px]">
          ...
          {activeTab === "pull-requests" && (
            ...
            // onOpenDetails={(id: string) =>
            //   navigate(`/pull/${id}`, {
            //     state: { activeTab: "pull-requests" }, // ⭐ CHANGED
            //   })
            // }
            />
          )}
